          ...
          $('#div-spinner').show();
            ...
            $.ajax({
              ...
              success: function (resp) {
               ...
               var balance = resp.lista;
                $("#totalDebe_").text(resp.totalDebe);
               $("#totalHaber_").text(resp.totalHaber);
               $("#saldo_").text(resp.saldo);
...
function buscarBalanceDiario(){
	...
	$.ajax({
        ...
        success: function (resp) {
          ...
          var balance = resp.lista;
          $("#totalDebe").text(resp.totalDebe);
          $("#totalHaber").text(resp.totalHaber);
          $("#saldo").text(resp.saldo);
